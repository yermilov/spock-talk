...
Start with adding these three dependencies to your project:
...
If you already have test code you want to migrate to Spock either from JUnit of TestNG take there <> easy steps:
